...
const Description = ({username,
  ...
  alignItems="center"
  ><ProfileStyledPImage src={avatar}
  alt='User avatar'/><ProfileText fontSize='#010101'
  fontWeight='bold'
  fontColor='#010101'>{username}</ProfileText>
  <ProfileText>{tag}</ProfileText>
  <ProfileText>{location}</ProfileText></Box>
}
